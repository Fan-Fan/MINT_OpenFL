...
class ApplicationMain
{
	...
	{
		#if openfl
		flash.Lib.setPackage("MINTSPHERE", "MINT_OpenFL", "com.mintsphere.mint_openfl", "1.0.0");
		...
		wx.App.boot(function()
		{
			...
			frame = wx.Frame.create(null, null, "MINT_OpenFL", null, { width: 800, height: 450 });
			
			#if openfl
			var stage = wx.NMEStage.create(frame, null, null, { width: 800, height: 450 });
			#end
